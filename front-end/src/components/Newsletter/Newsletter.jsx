...
const Newsletter = () => {
  ...
  return (
    <div className='py-14' style={style}>
      <div className='container py-10  md:py-14  gap-y-6 sm:gap-y-0  sm:px-10 md:px-5 mx-auto bg-white flex flex-col md:flex-row items-center justify-between'>
        ...
        <div>
          <div className='flex border border-black pl-10 pr-2 py-2 justify-end'>
            <input type="email" className='pr-2 py-2 bg-transparent' placeholder='Enter your email' />
