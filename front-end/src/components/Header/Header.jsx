    ...
    <>
      ...
      <header className=' px-3 sm:px-10 py-3 bg-[#f0f2ee] flex justify-between items-center border-b border-b-b_gray'>
        <div className='flex items-center gap-x-24'>
          ...
          <div className={` lg:block ${mobileMenu ? "show-mobile-menu" : "hidden"}`}>
              ...
              <span className='relative group cursor-pointer flex items-center text-[15px] font-medium text-secondary hover:text-theme_color'>Pages
                ...
                <div className='opacity-0 invisible group-hover:opacity-100 group-hover:visible duration-300 z-40 w-[200px] absolute top-[45px] left-0 bg-gray-50 _shadow-sm px-6 py-5'>
                  <nav className='flex flex-col gap-y-4'>
                    <Link to="/cart" className='text-[13px] font-medium text-secondary  duration-300 hover:text-theme_color hover:border-l-2 hover:pl-2 hover:border-theme_color'>My Cart</Link>
                    <Link to="/checkout" className='text-[13px] font-medium text-secondary  duration-300 hover:text-theme_color hover:border-l-2 hover:pl-2 hover:border-theme_color'>Checkout</Link>
                    <Link to="/faq" className='text-[13px] font-medium text-secondary  duration-300 hover:text-theme_color hover:border-l-2 hover:pl-2 hover:border-theme_color'>FAQs</Link>
                    <Link to="/privacy-policy" className='text-[13px] font-medium text-secondary  duration-300 hover:text-theme_color hover:border-l-2 hover:pl-2 hover:border-theme_color'>Privacy & Policy</Link>
                  </nav>
                </div>
              </span>
        ...
        <div className='flex gap-x-8 items-center'>
          ...
          <button onClick={() => setMobileMenu(!mobileMenu)} className='lg:hidden'>
            <i className='bx text-2xl bx-menu-alt-right'>
            </i></button>
        </div>
      </header>
